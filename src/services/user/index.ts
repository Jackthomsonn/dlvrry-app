...
export class User {
  ...
  static async getConnectedAccountDetails(id: string) {
    ...
    return await Axios.post<string, AxiosResponse<Stripe.Account>>(
      `${Constants.manifest.extra.functionsUri}/getConnectedAccountDetails`,
      { id },
      {
        headers: {
          Authorization: token,
  ...
  static async getLoginLink(id: string) {
    ...
    return await Axios.post<string, AxiosResponse<Stripe.LoginLink>>(
      `${Constants.manifest.extra.functionsUri}/getLoginLink`,
      { id },
      {
        headers: {
          Authorization: token,
  ...
  static async onboardUser(
    ...
    return await Axios.post<string, AxiosResponse<string>>(
      `${Constants.manifest.extra.functionsUri}/onboardUser`,
      { email, id, refreshUrl, returnUrl },
      {
        headers: {
          Authorization: token,
        },
  ...
  static async getCards(customer_id: string) {
    ...
    return await Axios.post<any, AxiosResponse<any>>(
      `${Constants.manifest.extra.functionsUri}/getPaymentCards`,
      { customer_id, id: firebase.auth().currentUser.uid },
      {
        headers: {
          Authorization: token,
        },
